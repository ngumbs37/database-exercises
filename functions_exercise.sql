...
select 'Use concat() to combine their first and last name together' as 'Exercise 1';
...
select first_name, last_name, hire_date, datediff(curdate(), hire_date) as 'days on the job'  from employees
